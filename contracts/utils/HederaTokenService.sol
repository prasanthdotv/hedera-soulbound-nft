...
abstract contract HederaTokenService {
	...
	function getFungibleTokenInfo(
		...
		internal
		returns (int responseCode, IHederaTokenService.FungibleTokenInfo memory tokenInfo)
	{
		(bool success, bytes memory result) = precompileAddress.call(
	...
	function getNonFungibleTokenInfo(
		...
		internal
		returns (int responseCode, IHederaTokenService.NonFungibleTokenInfo memory tokenInfo)
	{
		(bool success, bytes memory result) = precompileAddress.call(
			abi.encodeWithSelector(
